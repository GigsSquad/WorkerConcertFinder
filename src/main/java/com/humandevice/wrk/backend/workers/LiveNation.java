		...
		while(!end){
			...
			for (Element concert:concertData){
				...
				int month=0;
					...
					switch(date[1]){
						case("sty"):{month=1;break;}
						case("lut"):{month=2;break;}
						case("mar"):{month=3;break;}
						case("kwi"):{month=4;break;}
						case("maj"):{month=5;break;}
						case("cze"):{month=6;break;}
						case("lip"):{month=7;break;}
						case("sie"):{month=8;break;}
						case("wrz"):{month=9;break;}
						case("paź"):{month=10;break;}
						case("lis"):{month=11;break;}
						case("gru"):{month=12;break;}
				}
					data=null;
